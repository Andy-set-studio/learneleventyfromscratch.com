...
If you go to <http://localhost:8080https://piccalil.li/blog/> now, you should see something that looks like this:

![A list of posts with an 'older posts' link that represents pagination](/images/courses/learn-eleventy-from-scratchhttps://piccalil.li/blog-feed.jpg)
